...
<div class="body" style="height: 600px;width: 600px;margin-top: 20px">
    <span>修改密码</span>
    <form onsubmit="return beforeSubmit(this);" name="insert" action="${pageContext.request.contextPath}/changePassword2">
        <table class="zhuce">
            <tr>
...
<script type="text/javascript">
    $("#yuan").blur(function () {
        ...
        console.log(yuan);
        $.ajax({
            url:"${pageContext.request.contextPath}/yuanPass2",
            type:"POST",
            data:"nam="+yuan,
            ...
            success:function (mm) {
                if(mm==0){
                    alert("原密码输入错误，请重新输入！");
                    window.location.href="${pageContext.request.contextPath}/jsp/changePassword2.jsp"
                }
            }
